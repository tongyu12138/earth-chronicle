...
const periods = [
  ...
  makePeriod({
    ...
    sources: [ICS_SOURCE, { name: 'Stromatolite reef from the Early Archaean era of Australia', publisher: 'Nature', url: 'https://www.nature.com/articles/nature04764' }],
  ...
  makePeriod({
    ...
    sources: [ICS_SOURCE, { name: 'Introduction to the Burgess Shale', publisher: 'Royal Ontario Museum', url: 'https://burgess-shale.rom.on.ca/introduction/' }],
  ...
  makePeriod({
    ...
    sources: [ICS_SOURCE, { name: 'Eurypterid', publisher: 'New York State Museum', url: 'https://nysm.nysed.gov/exhibitions/windows/eurypterid' }],
    eventIds: ['silurian-vascular-plants', 'silurian-jawed-fishes'],
    creatureIds: ['eurypterus', 'cooksonia', 'birkenia']
  }),
  makePeriod({
  ...
  makePeriod({
    ...
    sources: [ICS_SOURCE, { name: 'Les forêts luxuriantes du Carbonifère', publisher: 'Muséum national d’Histoire naturelle', url: 'https://www.mnhn.fr/fr/les-forets-luxuriantes-du-carbonifere' }],
  ...
  makePeriod({
    ...
    sources: [ICS_SOURCE, { name: 'Fossil Collection: Permian Glossopteris flora', publisher: 'Western Australian Museum', url: 'https://museum.wa.gov.au/research/collections/biostratigraphy/fossil-collection' }],
  ...
  makePeriod({
    ...
    sources: [ICS_SOURCE, { name: 'Plateosaurus', publisher: 'Natural History Museum, London', url: 'https://www.nhm.ac.uk/discover/dino-directory/plateosaurus.html' }],
    eventIds: ['first-dinosaurs', 'first-mammals', 'triassic-extinction'],
  ...
  makePeriod({
    ...
    sources: [ICS_SOURCE, { name: 'Archaeopteryx Nr. 11', publisher: 'Senckenberg Naturmuseum Frankfurt', url: 'https://museumfrankfurt.senckenberg.de/en/exhibition/highlight/archaeopteryx-nr-11/' }],
  ...
  makePeriod({
    ...
    sources: [ICS_SOURCE, { name: 'Triceratops', publisher: 'Natural History Museum, London', url: 'https://www.nhm.ac.uk/discover/dino-directory/triceratops.html' }],
  ...
  makePeriod({
    ...
    sources: [ICS_SOURCE, { name: 'Our earliest primate ancestors rapidly spread after dinosaur extinction', publisher: 'University of California, Berkeley', url: 'https://news.berkeley.edu/2021/02/24/our-earliest-primate-ancestors-rapidly-spread-after-dinosaur-extinction/' }],
  ...
  makePeriod({
    ...
    sources: [ICS_SOURCE, { name: 'Fossils & Geology — Fossil Butte National Monument', publisher: 'U.S. National Park Service', url: 'https://www.nps.gov/fobu/learn/fossils-geology.htm' }],
  ...
  makePeriod({
    ...
    sources: [ICS_SOURCE, { name: 'Exploring Ancient DNA of Fossil Mammals', publisher: 'American Museum of Natural History', url: 'https://www.amnh.org/explore/news-blogs/ancient-dna-fossil-mammals' }],
    eventIds: ['antarctic-ice-expansion', 'oligocene-faunal-turnover'],
  ...
  makePeriod({
    ...
    sources: [ICS_SOURCE, { name: 'Is megalodon still alive?', publisher: 'Natural History Museum, London', url: 'https://www.nhm.ac.uk/discover/is-megalodon-still-alive.html' }],
  ...
  makePeriod({
    ...
    sources: [ICS_SOURCE, { name: 'Laetoli Footprint Trails', publisher: 'Smithsonian Human Origins Program', url: 'https://humanorigins.si.edu/evidence/behavior/footprints/laetoli-footprint-trails' }],
  ...
  makePeriod({
    ...
    sources: [ICS_SOURCE, { name: 'Were all mammoths woolly?', publisher: 'Natural History Museum, London', url: 'https://www.nhm.ac.uk/discover/were-all-mammoths-woolly.html' }],
  ...
  makePeriod({
    ...
    overview: '末次冰期结束后，全球海平面在冰盖消融中上升，气候进入当前较温暖的间冰期，但区域干湿和温度仍持续波动。农业扩展在地表留下越来越强的信号，工业化后温室气体、物种迁移、污染和土地利用开始全球性改变地球系统。“人类世”是重要科学讨论概念，但没有被批准为正式地质年代单位。具体文明、工业和数字事件请进入独立的人类历史线阅读。',
    ...
    livingHere: '欢迎回到最熟悉又最不寻常的时期：海岸线、季风、冰川和生态系统仍在变化，而人类活动已经成为影响碳循环、生物多样性和沉积记录的重要力量。',
    misconceptions: ['“人类世”是重要讨论概念，但截至当前并非正式地质年代单位。'],
    sources: [ICS_SOURCE, { name: 'The variability of Holocene climate change: Evidence from varved lake sediments', publisher: 'U.S. Geological Survey', url: 'https://www.usgs.gov/publications/variability-holocene-climate-change-evidence-varved-lake-sediments' }],
    eventIds: [],
    humanHistoryEntryId: 'hunter-gatherer',
  ...
  makePeriod({
    ...
    sources: [HUMAN_SOURCE, { name: 'The oldest fossil of our genus', publisher: 'Smithsonian Human Origins Program', url: 'https://humanorigins.si.edu/research/whats-hot-human-origins/oldest-fossil-our-genus' }],
  ...
  makePeriod({
    ...
    livingHere: '日程表会突然被播种、收获和储粮占满。农业提供了稳定热量的可能，也把你绑进更密集的劳动和传染病网络。', misconceptions: ['农业并非毫无代价的线性“进步”，也不是全球同时发生。'],
    sources: [HUMAN_SOURCE, { name: 'Stone Sickle Blades', publisher: 'Smithsonian Human Origins Program', url: 'https://humanorigins.si.edu/evidence/behavior/getting-food/stone-sickle-blades' }],
    eventIds: ['agriculture']
  }),
  makePeriod({
    ...
    livingHere: '你会第一次感到“填表”成为文明核心技能：粮仓、税收、土地和契约都需要记录。文字很伟大，但最早用途不全是诗。', misconceptions: ['“文明”不是对其他生活方式高低排序的科学标签。'],
    sources: [HUMAN_SOURCE, { name: 'Making cuneiform tablets', publisher: 'British Museum', url: 'https://www.britishmuseum.org/research/projects/making-cuneiform-tablets' }],
    eventIds: ['first-cities', 'writing']
  }),
  makePeriod({
    ...
    livingHere: '跨洲信息可能需要数月抵达，但贸易网络已经能把香料、金属、纸张和思想送到遥远城市。你的“物流查询”只能问下一支商队。', misconceptions: ['古典时代并不只指希腊和罗马。'],
    sources: [HUMAN_SOURCE, { name: 'The Vindolanda tablets', publisher: 'British Museum', url: 'https://www.britishmuseum.org/collection/galleries/roman-britain/vindolanda-tablets' }],
    eventIds: ['paper-making']
  }),
  makePeriod({
    ...
    sources: [HUMAN_SOURCE, { name: 'Tropical Disease in Medieval Europe', publisher: 'Max Planck Institute for Geoanthropology', url: 'https://www.shh.mpg.de/1722164/tropical-disease-in-medieval-europe' }],
    eventIds: ['medieval-knowledge-networks', 'black-death']
  }),
  makePeriod({
    ...
    livingHere: '地图快速更新，书籍加速复制，但全球化的账单也写着疾病、掠夺和强迫迁移。技术扩大了连接，也扩大了权力的不平等。', misconceptions: ['哥伦布交换不是平等互惠的单纯商品交流。'],
    sources: [HUMAN_SOURCE, { name: 'Gutenberg Bible', publisher: 'Gutenberg Museum Mainz', url: 'https://www.gutenberg.de/en/bibel/' }],
    eventIds: ['printing-press', 'copernican-revolution']
  }),
  makePeriod({
    ...
    livingHere: '城市会更亮、更快，也更吵、更脏。蒸汽机不是单独按下的“现代化按钮”，它需要矿山、铁路、资本、劳动与制度共同运转。', misconceptions: ['工业革命不是只由一项发明造成，也不是各地同步发生。'],
    sources: [HUMAN_SOURCE, { name: 'Rotative Steam Engine by Boulton and Watt, 1788', publisher: 'Science Museum Group', url: 'https://collection.sciencemuseumgroup.org.uk/objects/co50948/rotative-steam-engine-by-boulton-and-watt-1788-beam-engine-steam-engine' }],
    eventIds: ['steam-engine', 'vaccination', 'natural-selection', 'germ-theory', 'electric-grid']
  }),
  makePeriod({
    ...
    livingHere: '你可能第一次坐上飞机、听广播或使用抗生素，也可能经历总体战。技术能力增长不自动等于社会会更明智地使用它。', misconceptions: ['青霉素不是发现后立刻普及；规模化生产和临床验证花了多年。'],
    sources: [HUMAN_SOURCE, { name: 'Penicillin cultures', publisher: 'Science Museum Group', url: 'https://collection.sciencemuseumgroup.org.uk/objects/co8246505/penicillin-cultures' }],
    eventIds: ['modern-physics', 'powered-flight', 'penicillin']
  }),
  makePeriod({
    ...
    sources: [HUMAN_SOURCE, { name: 'Transistor Samples', publisher: 'Smithsonian Institution', url: 'https://www.si.edu/object/transistor-samples%3Anmah_1213582' }],
